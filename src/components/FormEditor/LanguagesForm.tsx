...
export const LanguagesForm = () => {
  ...
  const onDragEnd = (result: DropResult) => {
    ...
    dispatch({ type: 'REORDER_LANGUAGES', payload: items });
  };
                ...
                <Draggable key={lang.id} draggableId={lang.id} index={index}>
                  {(provided, snapshot) => (
                    ...
                    >
                      ...
                      <h3 className="text-sm font-semibold text-slate-200 mb-4 pl-6 pr-8">Language {index + 1}</h3>
                      
                      <div className="grid grid-cols-2 gap-4 pl-6">
                        <div className="col-span-2 sm:col-span-1">
                          <label className="block text-sm font-medium text-[var(--app-text)] mb-1">Language</label>
                          <input
                            type="text"
                            value={lang.name}
                        ...
                        <div className="col-span-2 sm:col-span-1">
                          <label className="block text-sm font-medium text-[var(--app-text)] mb-1">Proficiency</label>
                          <input
                            type="text"
